...
dut::dut(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_dut_digitrec_fu_59 = new dut_digitrec("grp_dut_digitrec_fu_59");
    grp_dut_digitrec_fu_59->ap_clk(ap_clk);
    grp_dut_digitrec_fu_59->ap_rst(ap_rst);
    grp_dut_digitrec_fu_59->ap_start(grp_dut_digitrec_fu_59_ap_start);
    grp_dut_digitrec_fu_59->ap_done(grp_dut_digitrec_fu_59_ap_done);
    grp_dut_digitrec_fu_59->ap_idle(grp_dut_digitrec_fu_59_ap_idle);
    grp_dut_digitrec_fu_59->ap_ready(grp_dut_digitrec_fu_59_ap_ready);
    grp_dut_digitrec_fu_59->input_V(p_Result_s_reg_88);
    grp_dut_digitrec_fu_59->ap_return(grp_dut_digitrec_fu_59_ap_return);
    ...
    sensitive << ( grp_dut_digitrec_fu_59_ap_done );
    ...
    SC_METHOD(thread_grp_dut_digitrec_fu_59_ap_start);
    sensitive << ( ap_reg_grp_dut_digitrec_fu_59_ap_start );

    SC_METHOD(thread_p_Result_s_fu_70_p3);
    sensitive << ( tmp_V_reg_83 );
    sensitive << ( tmp_fu_66_p1 );
    ...
    sensitive << ( ap_sig_cseq_ST_st3_fsm_2 );
    sensitive << ( grp_dut_digitrec_fu_59_ap_done );
    sensitive << ( grp_dut_digitrec_fu_59_ap_return );
    ...
    ap_CS_fsm = "001";
    ap_reg_grp_dut_digitrec_fu_59_ap_start = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, tmp_V_reg_83, "tmp_V_reg_83");
    sc_trace(mVcdFile, ap_sig_57, "ap_sig_57");
    sc_trace(mVcdFile, p_Result_s_fu_70_p3, "p_Result_s_fu_70_p3");
    sc_trace(mVcdFile, p_Result_s_reg_88, "p_Result_s_reg_88");
    sc_trace(mVcdFile, grp_dut_digitrec_fu_59_ap_start, "grp_dut_digitrec_fu_59_ap_start");
    sc_trace(mVcdFile, grp_dut_digitrec_fu_59_ap_done, "grp_dut_digitrec_fu_59_ap_done");
    sc_trace(mVcdFile, grp_dut_digitrec_fu_59_ap_idle, "grp_dut_digitrec_fu_59_ap_idle");
    sc_trace(mVcdFile, grp_dut_digitrec_fu_59_ap_ready, "grp_dut_digitrec_fu_59_ap_ready");
    sc_trace(mVcdFile, grp_dut_digitrec_fu_59_ap_return, "grp_dut_digitrec_fu_59_ap_return");
    sc_trace(mVcdFile, ap_reg_grp_dut_digitrec_fu_59_ap_start, "ap_reg_grp_dut_digitrec_fu_59_ap_start");
    sc_trace(mVcdFile, tmp_fu_66_p1, "tmp_fu_66_p1");
...
void dut::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_dut_digitrec_fu_59_ap_ready.read())) {
            ap_reg_grp_dut_digitrec_fu_59_ap_start = ap_const_logic_0;
        }
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st2_fsm_1.read()) && !esl_seteq<1,1,1>(strm_in_V_V_empty_n.read(), ap_const_logic_0))) {
        p_Result_s_reg_88 = p_Result_s_fu_70_p3.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st1_fsm_0.read()) && !ap_sig_57.read())) {
        tmp_V_reg_83 = strm_in_V_V_dout.read();
    }
}

void dut::thread_ap_done() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_sig_cseq_ST_st3_fsm_2.read()) && 
         !(esl_seteq<1,1,1>(strm_out_V_V_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, grp_dut_digitrec_fu_59_ap_done.read())))) {
...
void dut::thread_ap_sig_57() {
    ap_sig_57 = (esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_0) || esl_seteq<1,1,1>(strm_in_V_V_empty_n.read(), ap_const_logic_0));
}
...
void dut::thread_grp_dut_digitrec_fu_59_ap_start() {
    grp_dut_digitrec_fu_59_ap_start = ap_reg_grp_dut_digitrec_fu_59_ap_start.read();
}

void dut::thread_p_Result_s_fu_70_p3() {
    p_Result_s_fu_70_p3 = esl_concat<17,32>(tmp_fu_66_p1.read(), tmp_V_reg_83.read());
}
...
void dut::thread_strm_out_V_V_din() {
    strm_out_V_V_din = esl_zext<32,4>(grp_dut_digitrec_fu_59_ap_return.read());
}
...
void dut::thread_tmp_fu_66_p1() {
    tmp_fu_66_p1 = strm_in_V_V_dout.read().range(17-1, 0);
}
...
void dut::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if (!(esl_seteq<1,1,1>(strm_out_V_V_full_n.read(), ap_const_logic_0) || esl_seteq<1,1,1>(ap_const_logic_0, grp_dut_digitrec_fu_59_ap_done.read()))) {
                ap_NS_fsm = ap_ST_st1_fsm_0;
            } else {
                ap_NS_fsm = ap_ST_st3_fsm_2;
            }
